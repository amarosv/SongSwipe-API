...
namespace DAL.Lists
{
    public class ListadosUserAlbumDAL
    {
        /// <summary>
        /// Esta función recibe el uid de un usuario, obtiene el top 10 de albumes con más me gusta del usuario
        ...
        public static async Task<List<Album>> getTop10LikedAlbumsByUserDAL(string uid)
        {
            ...
            try
            {
                ...
                {
                    cmd.CommandText = "EXEC Get10MostLikedAlbumsByUser @uid";
        ...
        /// <summary>
        /// Esta función recibe el uid de un usuario, obtiene el top 10 de albumes con más no me gusta del usuario
        /// y los devuelve como una lista
        /// </summary>
        /// <param name="uid">UID del usuario</param>
        /// <returns>Objeto con información y lista de albumes</returns>
        public static async Task<List<Album>> getTop10DislikedAlbumsByUserDAL(string uid)
        {
            List<(long idAlbum, int likes)> albumsDetails = new List<(long, int)>();
            List<Album> albums = new List<Album>();
            ...
            try
            {
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    cmd.CommandText = "EXEC Get10MostDislikedAlbumsByUser @uid";
                    cmd.Parameters.AddWithValue("@uid", uid);
        ...
        /// <summary>
        /// Esta función recibe el uid de un usuario, obtiene el top 10 de albumes con más swipes del usuario
        /// y los devuelve como una lista
        /// </summary>
        /// <param name="uid">UID del usuario</param>
        /// <returns>Objeto con información y lista de albumes</returns>
        public static async Task<List<Album>> getTop10SwipesAlbumsByUserDAL(string uid)
        {
            List<(long idAlbum, int likes)> albumsDetails = new List<(long, int)>();
            List<Album> albums = new List<Album>();
            ...
            try
            {
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    cmd.CommandText = "EXEC Get10MostSwipeAlbumsByUser @uid";
                    cmd.Parameters.AddWithValue("@uid", uid);
